...
// const peopleUpTo20 = people.find(user => user.age < 20) !== undefined;

// console.log(peopleUpTo20);
...
// const newNumbers = numbers.every(number => number % 2 === 0);
...
// { name: 'Bob', age: 19 },
// ];
// const filterUsers = user.filter(person => person.age > 20);
...
class Calculator {
    ...
    divide(value) {
        if (value === 0) {
            console.log ("Помилка! Ділення на 0 неможливе!");
        }
          this.value /= value;
          return this;
    }
